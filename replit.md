...
Охватывает: Алгебру, Геометрию, Русский язык (История КР убрана).
...
- `topics.ts`: Алгебра 23 темы, Геометрия 32 темы, Русский 6 тем (орфография, ССП, СПП, БСП, прямая речь, лексика)
