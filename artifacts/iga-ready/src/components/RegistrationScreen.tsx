      ...
      <div className="w-full max-w-md pt-12 px-6 flex flex-col flex-1">
        ...
        <div className="flex justify-center mb-6 relative">
          ...
          <div className="absolute top-0 right-0 bg-white rounded-[20px] p-3 shadow-md max-w-[160px] translate-x-4 -translate-y-4">
            <div className="text-[12px] font-medium leading-tight text-slate-700">
              {lang === 'ru'
                ? 'Привет! Я твой помощник. Давай начнем подготовку к ИГА вместе!'
                : 'Салам! Мен сенин жардамчыңмын. ЖМАТка даярданууну чогуу баштайлы!'}
            </div>
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--text-muted)] text-[15px] font-medium leading-relaxed">
            {lang === 'ru'
              ? 'Давай создадим твой профиль и начнем путь к успеху!'
              : 'Кел, профилиңди түзүп, ийгиликке жол баштайлы!'}
          </p>
        </div>
        ...
        <form
          ...
          className="bg-white rounded-[2rem] p-6 shadow-sm border border-[var(--card-border)] mb-8 flex-1"
        >
          <div className="space-y-4">

            {/* Name */}
            <div className="relative">
              <label className="absolute -top-2 left-4 bg-white px-1 text-[10px] font-black uppercase text-[var(--primary)] z-10">
                Имя
              </label>
              <input
                type="text"
                ...
                className="w-full h-14 px-4 rounded-[1.25rem] border-2 border-[var(--card-border)] focus:border-[var(--primary)] outline-none font-semibold placeholder:text-slate-300"
                required
              />
            </div>
            ...
            {/* Surname */}
            <div className="relative">
              <label className="absolute -top-2 left-4 bg-white px-1 text-[10px] font-black uppercase text-[var(--text-muted)] z-10">
                Фамилия
              </label>
              <input
                type="text"
            ...
            <div className="mt-8">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-[10px] uppercase font-black text-[var(--primary)] tracking-wider">
                  Шаг 1
                </span>
              </div>
